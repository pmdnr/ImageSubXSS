...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Cross Site Scripting Attacks Test Web Page - No Security">
    <link rel="icon" href="js-css/lt.ico">
    <title>Cross Site Scripting Attacks Test Web Page - No Security</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 10px;">
        <h3>XSS Test Web Page - No Security</h3>
        <p>The Data submitted through this web page will be accepted with out checking for Cross Site Scripting Attacks.</p>
      </div>
    ...
    $(document).ready(function(){
        $('#userForm').submit(function(){
            ...
            $.ajax({
                type: 'POST',
                url: 'nosecurityinputhandler.php', 
                data: $(this).serialize()
            })
            .done(function(data){
